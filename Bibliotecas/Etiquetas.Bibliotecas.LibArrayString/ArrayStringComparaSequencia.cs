...
namespace Etiquetas.Bibliotecas.LibArrayString
{
    public static class ArrayStringComparaSequencia
    {
        ...
        {
            var array2Vazio = LibArrayString.EhArrayStringNuloOuVazioOuComEspacosBrancoOuDBNull.Execute(array2);
            var parametrosVazio = array2Vazio && LibArrayString.EhArrayStringNuloOuVazioOuComEspacosBrancoOuDBNull.Execute(array1);
